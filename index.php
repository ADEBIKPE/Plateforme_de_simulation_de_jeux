                        ...
                        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="export_image.php?id=7" style="height: 450px; object-fit: cover;"  alt="Image 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="export_image.php?id=8" style="height: 450px; object-fit: cover;" alt="Image 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="export_image.php?id=3" style="height: 450px; object-fit: cover;" class="d-block w-100" alt="Image 3">
                                </div>
                                <div class="">
                                    <img src="export_image.php?id=5" style="height: 450px; object-fit: cover;" class="d-block w-100" alt="Image 4">
                                </div>
