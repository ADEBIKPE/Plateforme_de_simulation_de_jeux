...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 17 nov. 2023 à 22:04
...
(9, 'Diouf', 'Abdoul', 'abdoul@gmail.com', '$2y$12$JIswF.YAmdMYtxpLLm0ff.gTgRRlDtFcQh00gEuiaIRtIFuzq8IvC', 2, '2023-11-01', 'Abdoul_ahad');
...
--
ALTER TABLE `partie`
  MODIFY `idPartie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `inscription`
  ADD CONSTRAINT `inscription_ibfk_1` FOREIGN KEY (`idPartie`) REFERENCES `partie` (`idPartie`) ON DELETE CASCADE,
  ADD CONSTRAINT `inscription_ibfk_2` FOREIGN KEY (`idUser`) REFERENCES `user` (`idUser`) ON DELETE CASCADE;
