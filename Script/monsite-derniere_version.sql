...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 22 nov. 2023 à 06:59
...
CREATE TABLE `inscription` (
  ...
  `statut_inscription` int(11) NOT NULL
...
INSERT INTO `inscription` (`id`, `idPartie`, `idUser`, `statut_inscription`) VALUES
(2, 2, 12, 0),
(23, 2, 1, 0);
...
(12, 'Code Names', 'abc', 'règles/codenames_rg.pdf', 'Jeu de soci&eacute;t&eacute;', 'images/codeNames.jpg'),
...
(22, 'TEST1', 'TEST_BOSS1', 'règles/2 Sujet Pleins Feux.pdf', 'TEST1', 'images/6e280cbb356f5dbb6e0be56d1417ddc6.jpg');
...
INSERT INTO `partie` (`idPartie`, `date_partie`, `heure`, `duree`, `nb_max_necessaire`, `idJeu`, `statut_partie`) VALUES
(2, '2023-11-22', '15:25:00', '20', '15', 13, 0),
(3, '2023-11-09', '15:20:00', '30 min', '8', 19, 0),
(5, '2025-12-22', '20:30:00', '30 min', '8', 1, 0);
...
(11, 'LIL2306', 'Halil0623', 'haliltiam@yahoo.com', '$2y$10$Bk0.YU5UpPYxLoZDkCWajuahhNJ2fmjjBKXZNMhRvNknDYlb/iHk6', 1, '2023-11-15', 'GOAT_H'),
(12, 'LILBOSS', 'HalilBOSS', 'halilthiam06@gmail.com', '$2y$12$NVRlj5Hua3UW5x9P1FvOped8rcfGxMYx6l7SDrQxyuUO7gP/QXNrG', 2, '2023-11-08', 'LIL_BOSS'),
(13, 'TIAM23', 'Khalil23', 'halilth23@gmail.com', '$2y$12$zB6LOk8ZnVnOU8kgemaNGOWvkt1GVw0eR3MGzyYK3eksYJKsySxk6', 2, '2023-11-08', 'GOAT_TIAM'),
(14, 'Y&egrave;manlin', 'abolo', 'yemanabalo@gmail.com', '$2y$12$r9/nf90sMCc8Yc/g1.qxyub0ZUCXhZGxJOAOaIMSThdQTPITtOtgC', 2, '2023-11-24', 'yeman');
...
--
ALTER TABLE `partie`
  MODIFY `idPartie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
