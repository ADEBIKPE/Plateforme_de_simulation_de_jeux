...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 21 nov. 2023 à 11:41
...
INSERT INTO `inscription` (`id`, `idPartie`, `idUser`) VALUES
(1, 1, 12),
(2, 2, 12),
(3, 1, 13);
...
(1, '2023-11-21', '15:25:00', '55', '12', 15),
(2, '2023-11-22', '15:25:00', '20', '15', 13);
...
--
ALTER TABLE `inscription_partie`
  MODIFY `idInscription_Partie` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user`
  MODIFY `idUser` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
